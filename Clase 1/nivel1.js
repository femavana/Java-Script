...
let operando1=Number(prompt('Ingrese primer operando: '));
let operando2=Number(prompt('Ingrese segundo operando: '));
let operador=prompt('Ingrese un operador: + para SUMA, - para RESTA, * para MULTIPLICACION, / para DIVISION');
let resultado;

if(operador === '+'){
    let resultado=sumar(operando1,operando2);
    console.log(resultado);
}else if(operador === '-'){
    let resultado=restar(operando1,operando2);
    console.log(resultado);
}else if(operador === '*'){
    let resultado=multiplicar(operando1,operando2);
    console.log(resultado);
}else if(operador === '/'){
    let resultado=dividir(operando1,operando2);
    console.log(resultado);
}else{
    alert('El operador ingresado no existe');
}
